...
public class HUD : MonoBehaviour
{
    ...
    public void TargetingReticle(MeshCollider targetCollider)
    {
        ...
        topLeftBorder.GetComponent<RectTransform>().anchoredPosition = new Vector2(topLeftPosition.x, topLeftPosition.y);
        topRightBorder.GetComponent<RectTransform>().anchoredPosition = new Vector2(topRightPosition.x, topRightPosition.y);
        bottomLeftBorder.GetComponent<RectTransform>().anchoredPosition = new Vector2(bottomLeftPosition.x, bottomLeftPosition.y);
        bottomRightBorder.GetComponent<RectTransform>().anchoredPosition = new Vector2(bottomRightPosition.x, bottomRightPosition.y);
