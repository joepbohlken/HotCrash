...
{
    [HideInInspector]
    public static GameMasterV2 main;
    ...
    public void InitializeScene(int playerCount = 0)
    {
        ...
        for (int i = 0; i < playerCount; i++)
        {
            ...
            playerPrefabs[i].transform.parent = playerParentTransform;
            ...
            */
            ...
            for (int j = 0; j < playerCount; j++)
            {
                if (j != i)
                {
                    CarCanvas carCanvas = Instantiate(carCanvasPrefab, playerPrefabs[i].transform.GetChild(2).GetChild(3)).GetComponentInChildren<CarCanvas>();
        ...
        {
            Transform carCanvases = playerParentTransform.GetChild(x).GetChild(2).GetChild(3);
            ...
            for (int y = 0; y < playerCount; y++)
            {
                if (x != y)
                {
                    ...
                    carCanvas.cameraToFollow = playerParentTransform.GetComponentInChildren<Camera>();
                }
            }
        }
